...
<p>If you have any questions about this Policy, please contact us.  Policy was created with <a style="color:#222" target="_blank" title="Generate refund policy" href="https://www.websitepolicies.com/refund-policy-generator">WebsitePolicies.com</a></p>

<p>This document was last updated on October 16, 2018</p>

<h1>Terms and conditions</h1>

<p>These terms and conditions ("Terms", "Agreement") are an agreement between Website Operator ("Website Operator", "us", "we" or "our") and you ("User", "you" or "your"). This Agreement sets forth the general terms and conditions of your use of the <a target="_blank" rel="nofollow" href="http://tarifa.cash">tarifa.cash</a> website and any of its products or services (collectively, "Website" or "Services").</p>
...
<p>The formation, interpretation, and performance of this Agreement and any disputes arising out of it shall be governed by the substantive and procedural laws of Cádiz, Spain without regard to its rules on conflicts or choice of law and, to the extent applicable, the laws of Spain. The exclusive jurisdiction and venue for actions related to the subject matter hereof shall be the state and federal courts located in Cádiz, Spain, and you hereby submit to the personal jurisdiction of such courts. You hereby waive any right to a jury trial in any proceeding arising out of or related to this Agreement. The United Nations Convention on Contracts for the International Sale of Goods does not apply to this Agreement.</p>
...
<p>You may print a copy of any part of this Website for your personal or non-commercial use.<h2>Indemnification and warranties</h2>
